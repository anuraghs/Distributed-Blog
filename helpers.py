...
def get_output_connection_tuples(pid, IP, port_base):
    if pid == 1:
        return (IP, port_base + 2), (IP, port_base + 3), (IP, port_base + 4), (IP, port_base + 5)
    elif pid == 2:
        return (IP, port_base + 1), (IP, port_base + 3), (IP, port_base + 4), (IP, port_base + 5)
    elif pid == 3:
        return (IP, port_base + 1), (IP, port_base + 2), (IP, port_base + 4), (IP, port_base + 5)
    elif pid == 4:
        return (IP, port_base + 2), (IP, port_base + 1), (IP, port_base + 3), (IP, port_base + 5)
    elif pid == 5:
        return (IP, port_base + 1), (IP, port_base + 2), (IP, port_base + 3), (IP, port_base + 4)
